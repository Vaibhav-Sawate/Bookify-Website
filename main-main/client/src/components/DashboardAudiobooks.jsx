...
const DashboardAudiobooks = () => {
  ...
  return (
    <div className="w-full p-4 flex flex-col items-center justify-center">
      <div className="w-full flex flex-col md:flex-row justify-center items-center gap-4 md:gap-24">
        <NavLink
...
export const AudiobookCard = ({ data, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-full md:w-60 min-w-[180px] px-2 py-4 cursor-pointer hover:shadow-xl hover:bg-card bg-gray-100 shadow-md rounded-lg flex flex-col items-center"
    ...
    >
      ...
      <div className="w-full min-w-[180px] h-40 md:h-52 rounded-lg drop-shadow-lg overflow-hidden">
        <motion.img
